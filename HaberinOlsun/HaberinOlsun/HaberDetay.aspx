<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="HaberDetay.aspx.cs" Inherits="HaberinOlsun.HaberDetay" %>
    ...
    <div style="min-height: 500px;">
        <div class="yorum" style="margin-top:50px;">
            ...
            <asp:Panel ID="pnl_girisyok" runat="server" style="margin:20px 0;">
                <h2>Yorum yapabilmek için lütfen <a href="giris.aspx">giriş yapınız </a></h2>
            </asp:Panel>
