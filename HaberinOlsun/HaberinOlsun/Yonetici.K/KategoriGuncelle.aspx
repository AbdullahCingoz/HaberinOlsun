<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetici.K/Yonetici.Master" AutoEventWireup="true" CodeBehind="KategoriGuncelle.aspx.cs" Inherits="HaberinOlsun.Yonetici.K.KategoriGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="formContainer">
        ...
        <div class="formContent">
            ...
            <div class="row">
              <asp:LinkButton ID="lbtn_ekle" runat="server" OnClick="lbtn_ekle_Click1" CssClass="formButton">Kategori Güncelle</asp:LinkButton>
            </div>
         </div>
     </div>
</asp:Content>
